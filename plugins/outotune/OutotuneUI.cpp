...
public:
	OutotuneUI() : UI(512, 512) {
		...
		static const std::vector<std::pair<std::string, Color>> modeStates = {{"absolute", Colors::ModeAbsolute}, {"relative", Colors::ModeRelative}}; // TODO: ensure this ordering is consistent with MidiMode
